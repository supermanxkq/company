...
public class WriteLog {
	...
	*/
	...
	File fileParentDir=new File("D:/yufuinsert");//�ж�logĿ¼�Ƿ����
	...
	logFilePathName="D:/yufuinsert/"+year+month+day+".log";//��־�ļ���

	}else {

	logFilePathName="D:/yufuinsert/"+fileNameHead+year+month+day+".log";//��־�ļ���
