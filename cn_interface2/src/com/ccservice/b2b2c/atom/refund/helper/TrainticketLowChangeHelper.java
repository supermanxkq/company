...
import com.ccservice.b2b2c.atom.refund.handle.TrainticketLowChangehandle;
import com.ccservice.b2b2c.atom.server.Server;
import com.ccservice.b2b2c.base.train.Trainorder;
import com.ccservice.b2b2c.base.train.Trainticket;
import com.ccservice.b2b2c.ben.AirticketPaymentrecord;

public class TrainticketLowChangeHelper extends Refundframework implements Refundhelper {
    ...
    public TrainticketLowChangeHelper(long orderid) {
        super(orderid);
    ...
    public Class getProfitHandle() {
        return TrainticketLowChangehandle.class;
    }
    ...
    private List getTrainRefundAlipayMethod() {
        String sql = " [sp_TrainLowChangeAlipayMethod_select] @Orderid=" + this.trainorder.getId() + " ,@Ticketid="
                + this.trainticket.getId();
