...
import com.ccservice.b2b2c.atom.refund.handle.TrainticketRefundHandle;
import com.ccservice.b2b2c.atom.server.Server;
import com.ccservice.b2b2c.base.train.Trainorder;
import com.ccservice.b2b2c.base.train.Trainticket;
import com.ccservice.b2b2c.ben.AirticketPaymentrecord;

public class TrainticketRefundHelper extends Refundframework implements Refundhelper {
    ...
    public TrainticketRefundHelper(long orderid) {
        super(orderid);
    ...
    public Class getProfitHandle() {
        return TrainticketRefundHandle.class;
    }
    ...
    private List getTrainRefundAlipayMethod() {
        String sql = " [sp_TrainRefundAlipayMethod_select] @Orderid=" + this.trainorder.getId() + " ,@Ticketid="
