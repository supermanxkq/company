...
public class AlipayprofitNotifyHandleToTianQu extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        String partner = "2088501896926286";
        ...
        String mysign = Alipay_fuction.sign(params, "9r9o02o7ocy92rocmbybngz4dgxqyuv4");
                            ...
                            if (details.length >= 3) {
                                ...
                                if (details[2].equalsIgnoreCase("SUCCESS")) {
                                    ...
                                    for (int i = 1; i < rebates.length; i++) {// 第一个为退款信息，故从1起
                                        ...
                                        try {
                                            List<Profitshare> shares = service.findProfitRefundByOid(
                                                    fefundtrade.getOrderid(), fefundtrade.getBtype());
