...
public class CopyOfreadMangoHotelRoom {    
  ...
  public static void main(String[] args) throws Exception {   
	  String url = "http://localhost:8080/lthk_service/service/";
		...
		int sheetindex=1;
		//13822   20384   14230
		for(int count=19226;count<=20384;count++)
		{
			...
			hotelRequest.setCheckInDate("2011-06-01");
			hotelRequest.setCheckOutDate("2011-06-30");
			try {
									...
									if(ratePlan!=null&&ratePlan.length>0)
									{
										...
										for(int iii=0;iii<ratePlan.length;iii++)
										{
											if(ratePlan[iii].getRateplanName().equals("标准")){
												...
												List<Hotelprice> listhotelprice2=servier.findAllHotelprice(" where "+Hotelprice.COL_roomid+" = "+roomtype.getId()+" and "+Hotelprice.COL_datenumber+" = '2011-06'", "", -1, 0);
											...
											hotelprice.setDatenumber("2011-06");
