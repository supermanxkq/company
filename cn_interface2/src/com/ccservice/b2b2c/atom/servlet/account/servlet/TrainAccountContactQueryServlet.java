 ...
 * 查询常用联系人
 * @author WH
 * @time 2015年12月15日 下午6:35:56
 * @version 1.0
 */

@SuppressWarnings("serial")
public class TrainAccountContactQueryServlet extends HttpServlet implements Servlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //日志
        String logName = "TrainAccountContactQueryServlet";
        //随机数据
        ...
        try {
            ...
            //处理方法
            result = new TrainAccountOperateMethod().contactQuery(param, logName, random).toString();
        }
        catch (Exception e) {
