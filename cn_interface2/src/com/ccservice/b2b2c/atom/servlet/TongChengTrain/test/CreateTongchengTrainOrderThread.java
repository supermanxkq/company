...
public class CreateTongchengTrainOrderThread extends Thread {
    ...
    public CreateTongchengTrainOrderThread(String partnerid, String key, String trainorderurl, String orderid,
            String checi, String from_station_code, String from_station_name, String to_station_code,
            String to_station_name, String train_date, List<Trainpassenger> passengers) {
        super();
    ...
    public void run() {
        ...
        train_order(this.orderid, this.checi, this.from_station_code, this.from_station_name, this.to_station_code,
                this.to_station_name, this.train_date, this.passengers, r1);
    }
    ...
    private String train_order(String orderid, String checi, String from_station_code, String from_station_name,
        ...
        String jsonStr = "{\"callbackurl\":\"111\",\"partnerid\":\"" + partnerid + "\",\"method\":\"" + method
                + "\",\"reqtime\":\"" + reqtime + "\",\"sign\":\"" + sign + "\",\"orderid\":\"" + orderid
                + "\",\"checi\":\"" + checi + "\",\"from_station_code\":\"" + from_station_code
                + "\",\"from_station_name\":\"" + from_station_name + "\",\"to_station_code\":\"" + to_station_code
                + "\",\"to_station_name\":\"" + to_station_name + "\",\"train_date\":\"" + train_date
