...
public class Chendongqiangpiao {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String repUrl = "http://112.124.115.220:8080/Reptile/traininit";
        //        String cookieString = "JSESSIONID=0A01D733FCF1922DF99D759D722C83CB8B027DDCB3; BIGipServerotn=3151233290.17183.0000; current_captcha_type=Z";
        String cookieString = "JSESSIONID=0A01D94D9895C190268A54632A965F62AB886515D1; BIGipServerotn=1306067210.38945.0000; current_captcha_type=Z";

        Chendongqiangpiao chendongqp = new Chendongqiangpiao();
        ...
        //        passlist.add(new Passengerinfo("王成亮", "413026199310010970"));
        passlist.add(new Passengerinfo("郭玉香", "500236199307204347"));
        zuoxie = "3";//9:商务座，P:特等座，M:一等座，O:二等座，6:高级软卧，4:软卧，3:硬卧，2:软座，1:硬座，0:站票[无座]
        String train_code = "K1096";
        //        train_code = "T160";
        //        String train_date="2016-01-13";
        String train_date = "2016-02-01";
        chendongqp.searchandcreateorder(passlist, train_date, "广州", "万州", train_code, zuoxie, cookieString, repUrl);
    ...
    public String chendongqiang(List<Passengerinfo> passlist, String train_date, String sname, String ename,
        ...
        String prices = "1@1@1@1@1";
        String zwcodess = zuoxie + "@" + zuoxie + "@" + zuoxie + "@" + zuoxie + "@" + zuoxie;//二等座
        String oldPassengerStrs = getoldPassengerStrsstring(passlist, "3");
        String passengerTicketStrs = getpassengerTicketStrsstring(passlist, zuoxie, "3");
        String jieguo;
    ...
    public void zhangwenjuanqiang(String train_date, String sname, String ename, String train_code, String zuoxie,
        ...
        String oldPassengerStrs = getoldPassengerStrsstring(passlist, "1");
        //        String passengerTicketStrs = zuoxie + ",0,1,关欣,1,152201198112302010,,N_" + zuoxie
        //                + ",0,1,张文娟,1,342127198310010063,,N";
        String passengerTicketStrs = getpassengerTicketStrsstring(passlist, zuoxie, "1");
    ...
    private String getoldPassengerStrsstring(List<Passengerinfo> passlist, String ticketType) {
    ...
    private String getpassengerTicketStrsstring(List<Passengerinfo> passlist, String zuoxie, String ticketType) {
        String oldPassengerStrs = "";
        for (int i = 0; i < passlist.size(); i++) {
            //            String ticketType = "1";
