...
public class ElongQueryOrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            WriteLog.write("Elong_艺龙订单查询_ElongQueryOrderServlet", r1 + ":" + merchantId + ":" + timeStamp + ":"
                    + orderId + ":" + sign);
            if (ElongHotelInterfaceUtil.StringIsNull(merchantId) || ElongHotelInterfaceUtil.StringIsNull(timeStamp)
                ...
                result = new ElongQueryOrderDetailsMethod().queryOrderDetails(merchantId, timeStamp, orderId, sign, r1);
            }
        }
        catch (Exception e) {
            e.printStackTrace();
            ...
            WriteLog.write("Elong_艺龙订单查询_ElongQueryOrderServlet", r1 + ":reslut:" + result);
            out.print(result);
            out.flush();
            out.close();
        }
