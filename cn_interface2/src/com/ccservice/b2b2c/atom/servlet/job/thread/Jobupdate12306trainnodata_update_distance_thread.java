...
public class Jobupdate12306trainnodata_update_distance_thread extends Thread {
    String daodazhan;
    ...
    public Jobupdate12306trainnodata_update_distance_thread(String checi_String) {
        super();
