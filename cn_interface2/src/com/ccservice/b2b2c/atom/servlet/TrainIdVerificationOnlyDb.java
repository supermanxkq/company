...
import com.ccservice.b2b2c.util.TrainIdverificationPropetyUtil;
 ...
 * @author liangwei
 */
public class TrainIdVerificationOnlyDb extends HttpServlet {
    ...
    private String getTongchengIdVerificationURL(List<Trainpassenger> plist) throws Exception {
        ...
        String tongchengIdVerificationUrl = PropertyUtil.getValue("tongchengIdVerificationOnlyDbUrl",
                "Train.properties");
