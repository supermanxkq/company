...
public class TuNiuTrainAccountValidateServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            WriteLog.write("途牛接口:", r1 + ":值:" + result + "时间:" + starttime);
            JSONObject JsonFin = new JSONObject();
            JsonFin.put("trainAccount", trainAccount);
            JsonFin.put("pass", pass);
            result = JsonFin.toString();
            if (!result.equals("") || result != null) {
                TuNiuTrainAccountValidate tuniu = new TuNiuTrainAccountValidate();
                tuniu.validateLoginNameAndPassword(JsonFin);
            }
            ...
            result = "Exception异常";
            WriteLog.write("t同程火车票接口", r1 + ":reslut:" + e);
            e.printStackTrace();
        }
        finally {
            if (out != null) {
