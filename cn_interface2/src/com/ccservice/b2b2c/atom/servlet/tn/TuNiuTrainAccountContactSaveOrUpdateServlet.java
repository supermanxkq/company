...
public class TuNiuTrainAccountContactSaveOrUpdateServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            WriteLog.write("途牛增删改接口:", r1 + ":值:" + result + "时间:" + starttime);
            JSONObject JsonFin = new JSONObject();
            JsonFin.put("trainAccount", trainAccount);
            JsonFin.put("pass", pass);
            result = JsonFin.toString();
            if (!result.equals("") || result != null) {
                TuNiuTrainAccountContactSaveOrUpdate tuniu = new TuNiuTrainAccountContactSaveOrUpdate();
                result = tuniu.AddtrainAccount(JsonFin).toString();
                result = tuniu.UpdatetrainAccount(JsonFin).toString();
            }
            ...
            result = "Exception异常";
            WriteLog.write("途牛增删改接口", r1 + ":reslut:" + e);
            e.printStackTrace();
        }
        finally {
            if (out != null) {
    ...
    /*  private String decodeBASE64(String data) throws IOException {
          BASE64Decoder decoder = new BASE64Decoder();
          byte[] b = decoder.decodeBuffer(data);
          String mima = new String(b);
          return mima;
      }*/
}
