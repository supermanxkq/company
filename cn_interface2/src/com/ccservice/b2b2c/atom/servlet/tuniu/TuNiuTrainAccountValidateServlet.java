...
public class TuNiuTrainAccountValidateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        WriteLog.write("cookie查登录的传值", r1 + ":+reqString:第一次" + reqString);
        String result = "";
        try {
            out = res.getWriter();
            if (ElongHotelInterfaceUtil.StringIsNull(reqString)) {
                ...
                if (data.equals("")) {
                    ...
                    result = account.AccountValidate(jresult).toJSONString();
                    WriteLog.write("cookie查登录的传值", r1 + ":+reqString第二个:" + result);
                }
            }
        }
        catch (Exception e) {
            WriteLog.write("cookie查登录的传值", r1 + ":+reqString第三个:" + e);
            jsonObject.put("success", false);
