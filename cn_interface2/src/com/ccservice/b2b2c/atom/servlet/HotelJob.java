...
public class HotelJob implements Job{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		try{
			 ...
			 String url = "http://220.113.41.188/cn_service/service/";
		    	
		    	HessianProxyFactory factory = new HessianProxyFactory();
				IHotelService servier = (IHotelService) factory.create(IHotelService.class, url + IHotelService.class.getSimpleName()) ;
				String response="";		
				int pg=1;
				List<City> listcity= servier.findAllCity(" where 1=1 and "+City.COL_language+" =1", " order by id ", -1, 0);
				//List<City> listcity= servier.findAllCity(" where 1=1 and "+City.COL_id+" =91", " order by id ", -1, 0);
