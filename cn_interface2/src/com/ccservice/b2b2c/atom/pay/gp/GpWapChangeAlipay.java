 ...
 */
public class GpWapChangeAlipay extends AirSupper {
    public static void main(String[] args) {
        JSONObject msgobj = new JSONObject();
        String msg = new GpWapChangeAlipay(0, "TC16060810191").pay(msgobj, 0.1, "", 1);
     ...
     * @param OrderNumber
     */
    public GpWapChangeAlipay(long orderid, String OrderNumber) {
        if (orderid <= 0) {
    ...
    public String pay(JSONObject msgobj, double money, String goodsDesc, int ind) {
        try {
            ...
            WriteLog.write("GPalipay_pay_webChange", "localhost:" + notify_url);
            ...
            String out_trade_no = utilDate.getOrderNum(orderchange.getId() + "");//"wadfasdfasdfasd1f11111111";//
            //商户网站订单系统中唯一订单号，必填
            //订单名称
            String subject = orderchange.getId() + "FgOrderchangehandle";
            //必填
            //付款金额
            ...
            WriteLog.write("GPalipay_pay_webChange", "orderchangeid=" + orderchange.getId() + ":orderid="
                    + orderinfo.getId() + ":req_data:" + req_dataToken);
            //建立请求
            ...
            WriteLog.write("GPalipay_pay_webChange", "orderchangeid=" + orderchange.getId() + ":orderid="
                    + orderinfo.getId() + ":request_token:" + request_token);
            //业务详细
            ...
            WriteLog.write("GPalipay_pay_webChange", "orderchangeid=" + orderchange.getId() + ":orderid="
                    + orderinfo.getId() + ":接口异常" + e.getMessage());
            return "接口异常";
        }
    }
}
