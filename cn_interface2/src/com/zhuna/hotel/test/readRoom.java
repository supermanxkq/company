...
public class readRoom {
	...
	public static void main(String[] args) throws Exception{
		...
		//
			List<Hotel> listHotel = servier.findAllHotel(" where 1=1 and "+Hotel.COL_type+" =1 and "+Hotel.COL_hotelcode+" is not null and "+Hotel.COL_cityid+" <=82", "ORDER BY ID", -1, 0);
			...
			for(Hotel h:listHotel){
				...
				List<Roomtype>listroomtype=servier.findAllRoomtype(" where 1=1 and "+Roomtype.COL_name+" ='"+listroom.get(a).attributeValue("title")+"' and "+Roomtype.COL_hotelid+" ="+h.getId(), "", -1, 0);
				...
				List<Hotelprice>listprice=servier.findAllHotelprice(" where 1=1 and "+Hotelprice.COL_hotelid+" ="+h.getId()+" and "+Hotelprice.COL_roomid+" ="+roomtype.getId()+" and "+Hotelprice.COL_datenumber+" ='"+startDate.trim().substring(0,7)+"'", "", -1, 0);
				if(listprice.size()>0){
	...
	public static String getDateString(String hid)
	{
		...
		String urltemp="http://un.zhuna.cn/api/gbk/room.asp?u=831713&m=54fee3e2184ce526&hid="+hid+"&tm1=2011-08-21&tm2=2011-08-24";//导入房型
