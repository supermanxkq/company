...
public class RequestUtil {
    ...
    public static String post(String url, String data, String charset, Map<String, String> header, int timeout) {
        ...
        //返回
        return ElongHotelInterfaceUtil.StringIsNull(result) ? "" : result;
    }
    ...
    private static String submit(String url, String data, String reqType, String charset, Map<String, String> header,
        ...
        url = url.trim();
        charset = ElongHotelInterfaceUtil.StringIsNull(charset) ? "utf-8" : charset.trim();
        //使用代理
        String AgentIp = "";
        ...
        try {
            //使用代理
            if (!ElongHotelInterfaceUtil.StringIsNull(AgentIp) && AgentIp.contains(":")) {
