...
public class InterHotleTest extends TestCase {
	...
	public void testLo() throws Exception {
		...
		System.out.println(res.getGetLocationListResult().getError()
				.getErrorDescription());
		...
		for (FreeHotelSearchWebServiceStub.Loc l : lll) {
			System.out.println("名字:" + l.getName() + "," + l.getISOa3()
					+ ",???" + l.getMRegion() + ",???" + l.getNr() + ",???"
					+ l.getPCRange());
		}
	}
