...
<BODY>
	...
	<div align="center" style="font-size=12px;font-weight: bold;color=red;">
		<form name="kqPay" action="https://www.99bill.com/msgateway/recvMsgatewayMerchantInfoAction.htm" method="post">
			...
			<input type="text" name="payeeContactType" value="<%=payeeContactType %>"/>
			<input type="text" name="payeeContact" value="<%=payeeContact %>"/>			
			...
			<input type="text" name="payeeAmount" value="<%=payeeAmount %>"/>
			<input type="text" name="orderTime" value="<%=orderTime %>"/>
			<input type="text" name="productName" value="<%=productName %>"/>
			<input type="text" name="productNum" value="<%=productNum %>"/>
			...
			<input type="text" name="sharingData" value="<%=sharingData %>"/>
			<input type="text" name="sharingPayFlag" value="<%=sharingPayFlag %>"/>
