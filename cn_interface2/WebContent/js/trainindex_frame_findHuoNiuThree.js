...
var ViewLogic = {
	...
	GetStatusStr : function(data) {
		...
		strFormat = strFormat.replace('{countorder}', countorder);
	...
	LoadData : function(series) {
		...
		var url = "/cn_interface/huoniu?year=0&month=1&day=1&hour=1&orderstatus=3&dataType=1&showType=-1&showover=4";
		$.ajax({
			type : "GET",
			url : url,
			dataType : "json",
